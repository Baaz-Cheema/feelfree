        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border border-green-100">
                <div class="flex items-center justify-between mb-2">
                    <h2 class="text-xl font-semibold text-gray-800">Worried about my future career</h2>
                    <span class="text-sm text-gray-500">2 mins ago</span>
                </div>
                <p class="text-gray-600 mb-4">
                    I'm not sure if I'm on the right path. Everything seems so uncertain right now.
                </p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border border-green-100">
                <div class="flex items-center justify-between mb-2">
                    <h2 class="text-xl font-semibold text-gray-800">Having trouble sleeping lately</h2>
                    <span class="text-sm text-gray-500">5 mins ago</span>
                </div>
                <p class="text-gray-600 mb-4">
                    My mind keeps racing at night and I can't seem to get proper rest. Anyone else experiencing this?
                </p>
                <div class="flex items-center justify-between pt-4 border-t border-green-100">
                    <div class="flex items-center space-x-4 text-gray-500">
                        <div class="flex items-center">
